...
import { shouldSyncArgusWorkflowDocument } from "@/lib/argus/workflow";
  ...
  useEffect(() => {
    if (
      ...
      !shouldSyncArgusWorkflowDocument({
        ...
        content: previewDocument.content ?? undefined,
      })
    ) {
      return;
    }
    ...
    setArtifact((currentArtifact) => {
      if (
        currentArtifact.documentId === previewDocument.id &&
        currentArtifact.content === previewDocument.content
      ) {
