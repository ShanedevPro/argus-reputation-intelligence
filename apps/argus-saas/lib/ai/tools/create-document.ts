  ...
  tool({
    ...
    inputSchema: z.object({
      ...
      content: z
        ...
        .optional()
        .describe(
          "Optional exact Markdown content to place in a text artifact. Use this when the document must preserve structured user-provided fields, such as an Argus Research Plan."
        ),
      kind: z
        .enum(artifactKinds)
        .describe(
