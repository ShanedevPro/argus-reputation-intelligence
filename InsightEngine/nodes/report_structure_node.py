...
class ReportStructureNode(StateMutationNode):
    ...
    def __init__(self, llm_client, query: str, structure_input: str | None = None):
        """
        初始化报告结构节点
        ...
        self.query = query
        self.structure_input = structure_input or query
    ...
    def run(self, input_data: Any = None, **kwargs) -> List[Dict[str, str]]:
        ...
        try:
            ...
            response = self.llm_client.stream_invoke_to_string(
                SYSTEM_PROMPT_REPORT_STRUCTURE, self.structure_input
            )
