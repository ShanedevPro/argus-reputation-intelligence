...
1. **chart.js** (204KB) - 用于图表渲染
   ...
   - 用途: legacy HTMLRenderer 兼容

2. **echarts.min.js** (1.1MB) - 用于 Argus HTML 报告图表渲染
   - 版本: 6.0.0
   - 来源: npm `echarts@6.0.0` (`dist/echarts.min.js`)
   - License: Apache-2.0，见 `echarts.LICENSE.txt` 和 `echarts.NOTICE.txt`

3. **chartjs-chart-sankey.js** (10KB) - Sankey图表插件
   - 版本: 0.12.0
   - 来源: https://unpkg.com/chartjs-chart-sankey@0.12.0/dist/chartjs-chart-sankey.min.js

4. **html2canvas.min.js** (194KB) - HTML转Canvas工具
   - 版本: 1.4.1
   - 来源: https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js

5. **jspdf.umd.min.js** (356KB) - PDF导出库
   - 版本: 2.5.1
   - 来源: https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js

6. **mathjax.js** (1.1MB) - 数学公式渲染引擎
   - 版本: 3.2.2
