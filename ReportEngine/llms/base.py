...
try:
    ...
    from llm_reasoning import reasoning_effort_params
except ImportError:
    ...
    def reasoning_effort_params(_engine_env_name: str, _override=None):
        return {}
...
class LLMClient:
    ...
    def __init__(self, api_key: str, model_name: str, base_url: Optional[str] = None):
        ...
        self.reasoning_effort_params = reasoning_effort_params("REPORT_ENGINE_REASONING_EFFORT")
    ...
    def invoke(self, system_prompt: str, user_prompt: str, **kwargs) -> str:
        ...
        call_reasoning_effort = kwargs.pop("reasoning_effort", None)
        if call_reasoning_effort is not None:
            extra_params.update(reasoning_effort_params("REPORT_ENGINE_REASONING_EFFORT", call_reasoning_effort))
        else:
            extra_params.update(self.reasoning_effort_params)
